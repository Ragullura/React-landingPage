...
export default function FeatureSection() {
  return (
    ...
    <div className='text-center sm:mt-10 lg:mt-14'>
        <span className='text-orange-500  lg:text-2xl bg-neutral-900 font-medium px-2 py-1 uppercase rounded-full h-6'>Feature
        </span>
